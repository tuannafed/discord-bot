...
export const data = new SlashCommandBuilder()
  .setName('milestone-unmute')
  .setDescription('Bật lại thông báo milestone PnL cho kèo của bạn')
  .addStringOption((opt) =>
    opt
      .setName('call_id')
      .setDescription('Chọn kèo muốn bật thông báo')
      .setRequired(true)
...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  ...
  const result = await callService.unmuteMilestone(callId, interaction.user.id);
  ...
  await interaction.editReply('🔔 Đã bật lại thông báo milestone cho kèo này.');
}
